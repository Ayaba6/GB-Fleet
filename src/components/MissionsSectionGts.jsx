...
const CardMissionGTS = ({ mission, chauffeur, camion, onEdit, onClose, onView }) => {
  ...
  switch (mission.statut) {
    case "Affectée":
      statutBg = "bg-yellow-600"; statutText = "text-white"; break;
    case "En Cours":
      statutBg = "bg-green-600"; statutText = "text-white"; break;
    case "En Chargement":
      statutBg = "bg-orange-600"; statutText = "text-white"; break;
    case STATUS_CLOSED:
      statutBg = "bg-gray-600"; statutText = "text-white"; break;
    default:
      statutBg = "bg-blue-600"; statutText = "text-white"; break;
  }
