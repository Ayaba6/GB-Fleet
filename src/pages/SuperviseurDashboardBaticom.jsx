// src/pages/SuperviseurDashboardBaticom.jsx
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-green-900 text-white flex flex-col justify-between">
        <div>
          <div className="p-5 text-center border-b border-green-700">
            <h1 className="text-2xl font-bold">BATICOM SUPERVISEUR</h1>
          </div>
          <nav className="mt-6">
            <ul>
              <li className="px-6 py-3 hover:bg-green-800 flex items-center gap-2 cursor-pointer">
                <LayoutDashboard size={18} /> Tableau de bord
              </li>
              <li className="px-6 py-3 hover:bg-green-800 flex items-center gap-2 cursor-pointer">
                <Truck size={18} /> Missions BATICOM
              </li>
              <li className="px-6 py-3 hover:bg-green-800 flex items-center gap-2 cursor-pointer">
      ...
      <main className="flex-1 p-6">
        <h2 className="text-2xl font-bold mb-4">Tableau de bord BATICOM</h2>
